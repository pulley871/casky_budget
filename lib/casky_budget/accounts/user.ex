defmodule CaskyBudget.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    field :state, :string
    field :phone, :string
    field :receipt_count, :integer, virtual: true
    ...
    many_to_many :organizations, CaskyBudget.Accounts.Organization,
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, CaskyBudget.Repo)
  ...
  """
  def valid_password?(%CaskyBudget.Accounts.User{hashed_password: hashed_password}, password)
