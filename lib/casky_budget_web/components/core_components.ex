defmodule CaskyBudgetWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CaskyBudgetWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CaskyBudgetWeb.Gettext, "errors", msg, opts)
    end
  end
